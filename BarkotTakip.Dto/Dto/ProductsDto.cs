...
namespace BarkotTakip.Dto.Dto
{
    public class ProductsDto
    {
        ...
        public Nullable<int> QuantityPerUnit
        {
            get; set;
        }
        ...
        public Nullable<int> StockCount
        {
            get; set;
        }
        public Nullable<bool> Discount
        {
            get; set;
        }
        ...
        public Nullable<decimal> InPrice
        {
            get; set;
        }
        public Nullable<decimal> SalesPrice
        {
            get; set;
        }
